...
describe('Visa intyg ts-diabetes', function() {
    ...
    describe('Verifiera ts-diabetes', function() {
        ...
        it('Verifiera "Allmänt"', function() {
            ...
            expect(viewPage.getTextContent('allmant-behandling-endastKost-allmant-behandling-tabletter-allmant-behandling-insulin-allmant-behandling-annanBehandling-0')).toEqual('Endast kost');
