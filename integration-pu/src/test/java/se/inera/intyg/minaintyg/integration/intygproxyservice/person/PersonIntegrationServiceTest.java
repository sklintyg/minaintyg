...
class PersonIntegrationServiceTest {
    ...
    class ErrorHandling {
        ...
        void shouldThrowIlligalArgumentExceptionIfPersonRequestContainsNullPersonId() {
            ...
            assertThrows(IllegalArgumentException.class, () -> personIntegrationService.getPerson(personRequest));
        }
        ...
        void shouldThrowRuntimeExceptionIfCommunicationErrorWithIntygProxyOccurs() {
            ...
            when(getPersonFromIntygProxyService.getPersonFromIntygProxy(personRequest)).thenThrow(RuntimeException.class);
    ...
    void shouldReturnPersonResponse() {
        ...
        final var expectedResult = PersonResponse.builder()
            ...
            .build();
        when(getPersonFromIntygProxyService.getPersonFromIntygProxy(personRequest)).thenReturn(expectedResult);
