...
class GetDynamicLinksServiceTest {
  ...
  @Mock private DynamicLinkRepository dynamicLinkRepository;
  @Mock private DynamicLinkConverter dynamicLinkConverter;

  @InjectMocks private GetDynamicLinksService service;
