...
class FormattedBannerConverterTest {
  ...
  private static final Banner BANNER =
      Banner.builder().id("ID").message("MESSAGE").priority(BannerPriority.HIGH).build();
  ...
  void shouldSetTypeErrorIfHigh() {
    final var response =
        formattedBannerConverter.convert(Banner.builder().priority(BannerPriority.HIGH).build());
  ...
  void shouldSetTypeObserveMedium() {
    final var response =
        formattedBannerConverter.convert(Banner.builder().priority(BannerPriority.MEDIUM).build());
  ...
  void shouldSetTypeInfoIfLow() {
    final var response =
        formattedBannerConverter.convert(Banner.builder().priority(BannerPriority.LOW).build());
