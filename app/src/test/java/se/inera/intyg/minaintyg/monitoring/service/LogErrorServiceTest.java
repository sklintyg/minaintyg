...
class LogErrorServiceTest {
  ...
  private static final LogErrorRequest REQUEST =
  ...
  @InjectMocks private LogErrorService logErrorService;
  ...
  void shouldLogUsingId() {
    ...
    verify(monitoringLogService)
        .logClientError(captor.capture(), anyString(), anyString(), anyString());
  ...
  void shouldLogUsingCode() {
    ...
    verify(monitoringLogService)
        .logClientError(anyString(), captor.capture(), anyString(), anyString());
  ...
  void shouldLogUsingMessage() {
    ...
    verify(monitoringLogService)
        .logClientError(anyString(), anyString(), captor.capture(), anyString());
  ...
  void shouldLogUsingStackTrace() {
    ...
    verify(monitoringLogService)
        .logClientError(anyString(), anyString(), anyString(), captor.capture());
