...
import se.inera.intyg.minaintyg.certificate.legacy.Certificate;
...
import se.inera.intyg.minaintyg.certificate.legacy.GetCertificateResponse;
import se.inera.intyg.minaintyg.certificate.legacy.GetCertificateService;
...
class GetCertificateServiceTest {
  ...
  private static final GetCertificateResponse EXPECTED_RESPONSE = GetCertificateResponse
      .builder()
      .certificate(
          Certificate
              .builder()
  ...
  @Mock
  GetCertificateService getCertificateIntegrationService;
  @InjectMocks
  se.inera.intyg.minaintyg.certificate.service.GetCertificateService getCertificateService;
  ...
  class GetCompleteCertificate {
    ...
    void shouldSetCertificateId() {
      final var captor = ArgumentCaptor.forClass(
          se.inera.intyg.minaintyg.certificate.legacy.GetCertificateRequest.class);
