...
module.exports = function(grunt) {
  ...
  grunt.file.write(DEST_DIR + 'app-deps.json', JSON.stringify(minaintyg.map(function(file) {
    return '/app/' + file;
  ...
  grunt.registerTask('generateModuleDeps', function() {
    ...
    Object.keys(modules).forEach(function(moduleName) {
      ...
      grunt.file.write(__dirname + module.dest + '/minaintyg/module-deps.json', JSON.stringify(files.map(function(file) {
