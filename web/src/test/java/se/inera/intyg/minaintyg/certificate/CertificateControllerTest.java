...
class CertificateControllerTest {
    ...
    private static final List<CertificateDTO> certificates = List.of(CertificateDTO.builder().build());
    ...
    class Response {
        ...
        void shouldSetContent() {
            final var response = certificateController.listCertificates(CertificatesRequest.builder().build());
