...
class CertificateStatusServiceImplTest {
    ...
    void shouldIncludeNotSentIfRecipientExistsButSentIsNull() {
        final var response = certificateStatusService.get(Collections.emptyList(), NOT_SENT_RECIPIENT, null);
    ...
    void shouldIncludeSentIfRecipientAndSentExists() {
        final var response = certificateStatusService.get(Collections.emptyList(), SENT_RECIPIENT, null);
    ...
    void shouldNotIncludeSeveralStatuses() {
        final var response = certificateStatusService.get(RENEWED_RELATIONS, SENT_RECIPIENT, NEW_ISSUED);
