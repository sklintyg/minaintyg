...
public class ExceptionTransformingAroundAdvice {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ExceptionTransformingAroundAdvice.class);
    ...
    public Object doRecoveryActions(ProceedingJoinPoint joinPoint) throws Throwable {
        try {
            ...
            LOGGER.error("Exception during web service call.", throwable);
