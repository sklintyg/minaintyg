...
angular.module('minaintyg').constant('minaintyg.messages', {
    'sv': {
        ...
        'faq.intyg.2.title' : 'Jag har laddat ner mitt intyg på min enhet men kan inte öppna filen.',
        'faq.intyg.2.body' : 'Intyget laddas ner som en PDF-fil. PDF är ett filformat som används för att ett dokument ska se likadant ut i olika enheter. För att kunna öppna PDF-filer behöver du en PDF-läsare, exempelvis <LINK:adobeReader>.',
