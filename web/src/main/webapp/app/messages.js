    ...
    'sv': {
        ...
        'help.faq':[
            {title:'',questions:[
                ...
                {question:'Varför kan jag inte se makulerade intyg?',answer:'<p>Vårdgivaren kan makulera ett intyg för att det innehåller ett allvarligt fel, till exempel om det är skrivit på fel patient.</p><p>Om en vårdgivare makulerar ett intyg, är det inte längre tillgängligt i Mina intyg.</p>'}]},
