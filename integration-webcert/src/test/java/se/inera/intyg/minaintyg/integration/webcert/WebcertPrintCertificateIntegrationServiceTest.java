...
class WebcertPrintCertificateIntegrationServiceTest {
  ...
  class ValidateRequest {
    ...
    @Test
    void shouldThrowErrorIfCustomizationIdIsNull() {
      final var request = PrintCertificateIntegrationRequest.builder().certificateId("id").build();
      assertThrows(IllegalArgumentException.class,
          () -> webcertPrintCertificateIntegrationService.print(request)
      );
    }
    ...
    @Test
    void shouldThrowErrorIfCustomizationIdIsEmpty() {
      final var request = PrintCertificateIntegrationRequest.builder()
          .certificateId("id")
          .customizationId("")
          .build();
