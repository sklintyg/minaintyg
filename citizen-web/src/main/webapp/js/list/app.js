...
var listCertApp = angular.module('ListCertApp', ['ui.bootstrap', 'mi.filters', 'services.listCertService', 'directives.message','directives.mi']).config([ '$routeProvider', function ($routeProvider) {
