...
public class UtlatandeToRegisterMedicalCertificateTest {
    ...
    public void testConversionMinimalSmiL() throws JAXBException, IOException, SAXException {
        ...
        ObjectMapper objectMapper = new CustomObjectMapper();
        Utlatande utlatande = objectMapper.readValue(new ClassPathResource("lakarutlatande/minimalt-SmiL-fk7263.json").getInputStream(), Utlatande.class);
        ...
        // read expected XML and compare with resulting RegisterMedicalCertificate
        String expectation = FileUtils.readFileToString(new ClassPathResource("register-medical-certificate/register-medical-certificate-minimalt-SmiL-fk7263.xml").getFile());
